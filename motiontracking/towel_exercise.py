...
def send_keypoints(keypoints_dict):
    ...
    try:
        ...
        print("Fout bij het versturen keypoints:",exception)
...
def send_event(state, calibration_status=None):
    ...
    try:
        ...
        print("Fout bij versturen van calibratie data:", exception)
        return None
...
while not calibrated:
    ...
    try:
        ...
        print("Fout bij calibratie-request:", exception)
        calibrated = False
